...
type SignUp struct {
	...
	UserSettings SignUpUserSettings `json:"user_settings" validate:"required,dive"`
}
...
// SignUpUserSettings struct to describe user settings.
type SignUpUserSettings struct {
